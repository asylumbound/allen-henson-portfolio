...
const staticProducts: Record<string, {
  ...
  "editorial-on-the-run": {
    ...
    price: 5000,
    priceMax: null,
    image: assetUrl("/images/sales/editorial-on-the-run.webp"),
    category: "book",
    status: "available",
  ...
  "editorial-on-the-rocks": {
    ...
    price: 5000,
    priceMax: null,
    image: assetUrl("/images/sales/editorial-on-the-rocks.webp"),
    category: "book",
    status: "available",
  ...
  "abscond-series": {
    ...
    price: 51000,
    priceMax: null,
    image: assetUrl("/images/sales/abscond-series.webp"),
    category: "book",
    status: "presale",
  ...
  "abscond-vol1-france": {
    ...
    price: 5000,
    priceMax: null,
    image: assetUrl("/images/sales/abscond-vol1-france.webp"),
    category: "book",
    status: "presale",
  ...
  "tour-de-eiffel": {
    ...
    price: 269000,
    priceMax: 555000,
    image: assetUrl("/images/sales/tour-de-eiffel.webp"),
    category: "print",
    status: "available",
  ...
  "il-pantheon": {
    ...
    price: 500000,
    priceMax: null,
    image: assetUrl("/images/sales/il-pantheon.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "sarah-in-london": {
    ...
    price: 110000,
    priceMax: null,
    image: assetUrl("/images/sales/sarah-in-london.webp"),
    category: "print",
    status: "available",
  ...
  "sword-bordeaux-v2": {
    ...
    price: 375000,
    priceMax: 475000,
    image: assetUrl("/images/sales/sword-bordeaux-v2.webp"),
    category: "print",
    status: "available",
  ...
  "raffaella-tresor": {
    ...
    price: 150000,
    priceMax: 240000,
    image: assetUrl("/images/sales/raffaella-tresor.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "sacrilege-toulouse": {
    ...
    price: 555000,
    priceMax: 770000,
    image: assetUrl("/images/sales/sacrilege-toulouse.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "mi-trevi": {
    ...
    price: 190000,
    priceMax: 350000,
    image: assetUrl("/images/sales/mi-trevi.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "sword-bordeaux-v1": {
    ...
    price: 450000,
    priceMax: 650000,
    image: assetUrl("/images/sales/sword-bordeaux-v1.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "sarina-thai": {
    ...
    price: 595000,
    priceMax: 900000,
    image: assetUrl("/images/sales/sarina-thai.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "entourage-pantheon-vii": {
    ...
    price: 500000,
    priceMax: null,
    image: assetUrl("/images/sales/entourage-pantheon-vii.webp"),
    category: "print",
    status: "available",
  ...
  "entourage-pantheon": {
    ...
    price: 500000,
    priceMax: null,
    image: assetUrl("/images/sales/entourage-pantheon.webp"),
    category: "print",
    status: "available",
    details: "Limited edition of 150\n\nIncludes Verisart Certificate of Authenticity",
  },
  "agency-fees": {
    ...
    price: 860000,
    priceMax: null,
    image: assetUrl("/images/sales/agency-fees.webp"),
    category: "print",
    status: "sold_out",
    details: "SOLD OUT",
  },
  "tour-eiffel-paris": {
    ...
    price: 245000,
    priceMax: 275000,
    image: assetUrl("/images/sales/tour-eiffel-paris.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "sunbathers-miami": {
    ...
    price: 270000,
    priceMax: null,
    image: assetUrl("/images/sales/sunbathers-miami.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "editorial-silver-gelatin": {
    ...
    price: 520000,
    priceMax: null,
    image: assetUrl("/images/sales/editorial-silver-gelatin.webp"),
    category: "print",
    status: "available",
  ...
  "journal-44": {
    ...
    price: 1500000,
    priceMax: null,
    image: assetUrl("/images/sales/journal-44.webp"),
    category: "book",
    status: "sold_out",
  ...
  "zines": {
    ...
    price: 9500,
    priceMax: null,
    image: assetUrl("/images/sales/zines.webp"),
    category: "book",
    status: "sold_out",
    details: "SOLD OUT",
  },
  "leaving-mondrian": {
    ...
    price: 1399999,
    priceMax: null,
    image: assetUrl("/images/sales/leaving-mondrian.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "girl-smoking-coral": {
    ...
    price: 970000,
    priceMax: null,
    image: assetUrl("/images/sales/girl-smoking-coral.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  ...
  "odlh-set": {
    ...
    price: 0,
    priceMax: null,
    image: assetUrl("/images/sales/odlh_set.webp"),
    category: "print",
    status: "sold_out",
  ...
  "anna-oakley-silver-gelatin": {
    ...
    price: 1290000,
    priceMax: null,
    image: assetUrl("/images/sales/anna-oakley-silver-gelatin.webp"),
    category: "print",
    status: "available",
  ...
  "corset-en-metal": {
    ...
    price: 1510000,
    priceMax: null,
    image: assetUrl("/images/sales/Corset_en_Metal.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "rudy-reyes-24x36": {
    ...
    price: 655000,
    priceMax: 710000,
    image: assetUrl("/images/sales/rudy-reyes-24x36.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "rudy-reyes-ii": {
    ...
    price: 120000,
    priceMax: 530000,
    image: assetUrl("/images/sales/Rudy_Reyes_II.webp"),
    category: "print",
    status: "available",
  ...
  "girl-coal-ny": {
    ...
    price: 530000,
    priceMax: 770000,
    image: assetUrl("/images/sales/Girl_Coal_NY_2015_GC001_015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "foro-romano": {
    ...
    price: 310000,
    priceMax: 495000,
    image: assetUrl("/images/sales/Foro_Romano_Rome_Italy_LP07.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "journal-22": {
    ...
    price: 800000,
    priceMax: null,
    image: assetUrl("/images/sales/journal-22-allen-henson.webp"),
    category: "book",
    status: "sold_out",
    details: "SOLD OUT\n\nOriginal handwritten journal.",
  },
  "anna-lisa-sequoia": {
    ...
    price: 410000,
    priceMax: 670000,
    image: assetUrl("/images/sales/anna_lisa_in_sequoiadendron_giganteum.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "what-we-left-paris": {
    ...
    price: 1550000,
    priceMax: 1700000,
    image: assetUrl("/images/sales/what-we-left-in-paris.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "ipseity": {
    ...
    price: 540000,
    priceMax: null,
    image: assetUrl("/images/sales/ipseity-ips001-015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "mouvement-paris": {
    ...
    price: 610000,
    priceMax: 940000,
    image: assetUrl("/images/sales/Mouvement_Paris_MV001-015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "burlesque-ny-2015": {
    ...
    price: 780000,
    priceMax: null,
    image: assetUrl("/images/sales/burlesque-new-york-2015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "walk-to-cafe-paris": {
    ...
    price: 995000,
    priceMax: 1355000,
    image: assetUrl("/images/sales/a_walk_to_the_Cafe_-_Paris_June_[CAFE001-015].webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "helene-traasavik-i": {
    ...
    price: 350000,
    priceMax: null,
    image: assetUrl("/images/sales/helene-traasavik-i-los-angeles.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "gun-rights-la": {
    ...
    price: 1299000,
    priceMax: null,
    image: assetUrl("/images/sales/Gun_Rights_Los_Angeles_2012.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "odeon-herodes-atticus": {
    ...
    price: 1515000,
    priceMax: 1650000,
    image: assetUrl("/images/sales/The_Odeon_of_Herodes_Atticus_Mannequin.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "mi-trevi-skye-roma": {
    ...
    price: 1175000,
    priceMax: 1525000,
    image: assetUrl("/images/sales/mi-trevi-skye-in-roma-mt001-015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "girl-on-coral": {
    ...
    price: 1770000,
    priceMax: 2245000,
    image: assetUrl("/images/sales/girl-on-coral.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "ryan-hunter-miami": {
    ...
    price: 1170000,
    priceMax: null,
    image: assetUrl("/images/sales/ryan-hunter-miami-venetian-2014.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "sarina-flatiron": {
    ...
    price: 1290000,
    priceMax: null,
    image: assetUrl("/images/sales/Sarian_Flatiron_Building_NYC_2015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "mannequin-mast-barcelona": {
    ...
    price: 700000,
    priceMax: 820000,
    image: assetUrl("/images/sales/Mannequin_on_the_Mast_en_Barcelona_SB10.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "colosseum-rome": {
    ...
    price: 235000,
    priceMax: null,
    image: assetUrl("/images/sales/Colosseum_Rome_C99.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "room-102-access": {
    ...
    price: 25000,
    priceMax: null,
    image: assetUrl("/images/sales/room_102_access.webp"),
    category: "access",
    status: "available",
  ...
  "sacrilege-toulouse-skye": {
    ...
    price: 2250000,
    priceMax: 2350000,
    image: assetUrl("/images/sales/Sacrilege_a_Toulouse_Skye_in_Toulouse_SAT001_015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "emily-shephard-bisjoux": {
    ...
    price: 1140000,
    priceMax: null,
    image: assetUrl("/images/sales/Emily-Shephard-in-BISJOUX-II-ESBi001-015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "good-morning-paris": {
    ...
    price: 2250000,
    priceMax: null,
    image: assetUrl("/images/sales/skye-eiffel-tower-good-morning-paris.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "editorial-bundle": {
    ...
    price: 9000,
    priceMax: null,
    image: assetUrl("/images/sales/editorial_on_the_run_and_editorial_on_the_rocks.webp"),
    category: "book",
    status: "available",
  ...
  "journal-23": {
    ...
    price: 900000,
    priceMax: null,
    image: assetUrl("/images/sales/Journal_23_Allen_Henson.webp"),
    category: "book",
    status: "sold_out",
    details: "SOLD OUT\n\nOriginal handwritten journal.",
  },
  "karyna-studio-ny": {
    ...
    price: 630000,
    priceMax: null,
    image: assetUrl("/images/sales/Karyna-Studio-NY-KAS001-015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "bespoke-camera-handles": {
    ...
    price: 35000,
    priceMax: null,
    image: assetUrl("/images/sales/bespoke-wooden-camera-handles-by-allen-henson.webp"),
    category: "accessory",
    status: "sold_out",
  ...
  "karyna-on-dock": {
    ...
    price: 1270000,
    priceMax: null,
    image: assetUrl("/images/sales/Karyna_on_Dock.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "kara-gibson-la-ii": {
    ...
    price: 1300000,
    priceMax: null,
    image: assetUrl("/images/sales/Kara_Gibson_AH_Studio_LA_II_2012.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "leia-contois-la": {
    ...
    price: 1250000,
    priceMax: null,
    image: assetUrl("/images/sales/leia-contois-los-angeles-2012.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "pantheon-roma-2015": {
    ...
    price: 140000,
    priceMax: null,
    image: assetUrl("/images/sales/Pantheon-Roma-2015.webp"),
    category: "print",
    status: "sold_out",
    details: "SOLD OUT",
  },
  "arc-de-triomphe": {
    ...
    price: 170000,
    priceMax: null,
    image: assetUrl("/images/sales/arc-de-triomphe-paris.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "portrait-girl-ny": {
    ...
    price: 500000,
    priceMax: null,
    image: assetUrl("/images/sales/a-portrait-of-a-girl-ny-px001-015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "london-big-ben": {
    ...
    price: 250000,
    priceMax: null,
    image: assetUrl("/images/sales/london-big-ben-l001-015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "cate-underwood-manhattan": {
    ...
    price: 390000,
    priceMax: null,
    image: assetUrl("/images/sales/cate-underwood-manhattan-2014.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "tika-camaj-miami": {
    ...
    price: 150000,
    priceMax: null,
    image: assetUrl("/images/sales/Tika_Camaj_Miami_Venetian_2014.webp"),
    category: "print",
    status: "sold_out",
    details: "SOLD OUT",
  },
  "data-licensing": {
    ...
    price: 0,
    priceMax: null,
    image: assetUrl("/images/sales/Data_Licensing.webp"),
    category: "license",
    status: "available",
  ...
  "gianluca-di-sotto": {
    ...
    price: 350000,
    priceMax: null,
    image: assetUrl("/images/sales/gianluca_di_sotto_nyc_les_2014.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "karyna-brooklyn": {
    ...
    price: 130000,
    priceMax: null,
    image: assetUrl("/images/sales/Karyna-Brooklyn-2015.webp"),
    category: "print",
    status: "sold_out",
    details: "SOLD OUT",
  },
  "sara-balint-fidi": {
    ...
    price: 520000,
    priceMax: null,
    image: assetUrl("/images/sales/sara-balint-fidi-nyc-2014.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "another-4am-miami": {
    ...
    price: 70000,
    priceMax: null,
    image: assetUrl("/images/sales/another-4-am-shoot-miami-beach-2014.webp"),
    category: "print",
    status: "sold_out",
    details: "SOLD OUT",
  },
  "karyna-union-league-ii": {
    ...
    price: 220000,
    priceMax: null,
    image: assetUrl("/images/sales/Karyna-Union-League-Club-II-2015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "karyna-union-league": {
    ...
    price: 270000,
    priceMax: null,
    image: assetUrl("/images/sales/karyna_union_league_club.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "karyna-grand-central": {
    ...
    price: 290000,
    priceMax: null,
    image: assetUrl("/images/sales/Karyna-Grand-Central-Station.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  ...
  "kat-miami-beach": {
    ...
    price: 150000,
    priceMax: null,
    image: assetUrl("/images/sales/kat-miami-beach-2014.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "shelby-carter-empire-state": {
    ...
    price: 270000,
    priceMax: null,
    image: assetUrl("/images/sales/Shelby-Carter-Elizabeth-Marxs-Empire-State-Building-2013-1of5.webp"),
    category: "print",
    status: "available",
  ...
  "helene-traasavik-ii": {
    ...
    price: 170000,
    priceMax: null,
    image: assetUrl("/images/sales/helene-traasavik-ii-los-angeles-2013.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "burlesque-ii-ny": {
    ...
    price: 300000,
    priceMax: null,
    image: assetUrl("/images/sales/burlesque-ii-new-york-2015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "laundry-day-la": {
    ...
    price: 95000,
    priceMax: null,
    image: assetUrl("/images/sales/laundry-day-los-angeles-2012.webp"),
    category: "print",
    status: "sold_out",
    details: "SOLD OUT",
  },
  "victorious-venetian": {
    ...
    price: 150500,
    priceMax: null,
    image: assetUrl("/images/sales/victorious-on-venetian-rooftop-2014-miami-beach.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "karyna-soho-nyc": {
    ...
    price: 65000,
    priceMax: null,
    image: assetUrl("/images/sales/Karyna_in_SoHo_NYC_2014.webp"),
    category: "print",
    status: "sold_out",
    details: "SOLD OUT",
  },
  "batch-a113": {
    ...
    price: 200000,
    priceMax: null,
    image: assetUrl("/images/sales/batch-a113-pt1of2.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
  "paon-au-greystone": {
    ...
    price: 500000,
    priceMax: null,
    image: assetUrl("/images/sales/paon-au-greystone-pag001-015.webp"),
    category: "print",
    status: "available",
    details: "24\"X36\" & 11\"X17\" options available\n\nCustom sizes by special order",
  },
      ...
      <div className="min-h-screen py-8 sm:py-12 md:py-20">
        <div className="container">
          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            >
              <ImageGallery
                images={getProductImages(product.slug, product.image || assetUrl("/images/placeholder.webp"))}
                alt={product.name}
              />
            </motion.div>
